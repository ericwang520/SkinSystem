package me.yiyi1234.skinsystem.entityhide;
...
public class EntityHider implements Listener {
    ...
    public EntityHider(Plugin plugin, Policy policy) {
        ...
        // Save policy
        this.policy = policy;
        this.manager = SkinSystem.getInstance().protocolManager;
    ...
    public final boolean hideEntity(Player observer, Entity entity) {
        ...
        if (visibleBefore) {
            ...
            integerArrayList.add(entity.getEntityId());
            destroyEntity.getIntLists().write(0, integerArrayList);
